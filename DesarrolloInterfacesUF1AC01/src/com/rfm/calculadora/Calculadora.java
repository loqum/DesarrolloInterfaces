...
public class Calculadora {
	...
	private void initialize() throws Exception {
		...
		frmCalculadora.getContentPane().setLayout(gridBagLayout);
						...
						frmCalculadora.getContentPane().add(panelOperandos, gbc_panelOperandos);
								...
								inputOperandoUno.setColumns(10);
										...
										panelOperandos.add(labelOperador, gbc_labelOperador);
												...
												panelOperandoDos.setLayout(null);
														...
														frmCalculadora.getContentPane().add(panelOperadores, gbc_panelOperadores);
