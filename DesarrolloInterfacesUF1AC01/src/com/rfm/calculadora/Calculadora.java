...
public class Calculadora {
	...
	private void initialize() throws Exception {
		...
		frmCalculadora.setIconImage(Toolkit.getDefaultToolkit().getImage(
		...
		frmCalculadora.setBounds(100, 100, 520, 175);
		...
		panelOperandos.setBounds(20, 25, 473, 46);
		frmCalculadora.getContentPane().add(panelOperandos);
		...
		labelEsIgual.setFont(new Font("Dialog", Font.BOLD, 16));
		...
		panelOperadores.setBounds(20, 87, 473, 41);
		frmCalculadora.getContentPane().add(panelOperadores);
		...
		gbc_buttonSuma.fill = GridBagConstraints.BOTH;
		...
		gbc_buttonResta.fill = GridBagConstraints.BOTH;
		...
		gbc_buttonMultiplicacion.fill = GridBagConstraints.BOTH;
		...
		gbc_buttonDivision.fill = GridBagConstraints.BOTH;
		...
		buttonResta.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (Utils.isNumeric(inputOperandoUno) && Utils.isNumeric(inputOperandoDos) && Utils.isEmpty(inputOperandoUno) == false && Utils.isEmpty(inputOperandoDos) == false) {
		...
		buttonDivision.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (Utils.isNumeric(inputOperandoUno) && Utils.isNumeric(inputOperandoDos) && Utils.isEmpty(inputOperandoUno) == false && Utils.isEmpty(inputOperandoDos) == false) {
					resultado = Utils.divide(Integer.parseInt(inputOperandoUno.getText()),
							Integer.parseInt(inputOperandoDos.getText()));
					inputResultado.setText(String.valueOf(resultado));
					labelOperador.setIcon(new ImageIcon(
							"C:\\Users\\rfernandezm\\git\\DesarrolloInterfaces\\DesarrolloInterfacesUF1AC01\\resources\\divide.png"));
				}
